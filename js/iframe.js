define([
	...
	Adapt.on("pageView:postRender menuView:postRender", function(view) {
		...
		$("body").addClass("scrollable scrollable-body");
		$(".drawer-inner").addClass("scrollable");
	});
	...
	Adapt.on("app:dataReady", function() {
		...
		if (isInIframe) {
			...
			var dynamicStyle = "html { height: 100%; width:100%; }";
        ...
        Adapt.on("router:location", function() {
        	if (isInIframe) top.window.document.getElementsByTagName("body")[0].scrollTop = 0;
	    });
